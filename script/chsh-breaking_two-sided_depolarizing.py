...
with respect to an amplitude damping channels acting each side of the entangled
system.
"""
...
def save_optimization_results(ansatz_name, x_range, y_range, opt_dicts):
    ...
    filename = "script/data/chsh-breaking_two-sided_depolarizing/" + ansatz_name + "/" + datetime_ext
    ...
    plt.title("Two-Sided Depolarizing in CHSH Scenario:\n" + ansatz_name)
